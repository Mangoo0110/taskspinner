...
class SaveAppearence implements AsyncEitherUsecase<Success, SaveAppearenceParams> {
  final SettingsRepo  repository;

  SaveAppearence(this.repository);

  @override
  Future<Either<DataCRUDFailure, Success>> call(SaveAppearenceParams params) async{
    return await repository.saveAppearence(
...
class SaveAppearenceParams {
  final Appearence defaultAppearence;
